      ...
      <el-main class="dc-page-content">
        <grid-layout
          ...
          <grid-item class="dc-widget-grid__item"
                     ...
                     drag-allow-from=".dc-widget-grid__item__header">
            <metrica-passport-tile-line-chart :title="gridTilesLayout[2].i" ref="metricaPassportLineChart">
          ...
          <grid-item class="dc-widget-grid__item"
            ...
            <metrica-passport-table :title="gridTilesLayout[3].i" ref="metricaPassportTable">

  ...
  <el-container class="dc-page-container">
    ...
    <el-container>
      ...
      <el-main class="dc-page-content">
        ...
        <el-button @click="saveAlarmRule()" round type="primary">Сохранить</el-button>
        <el-button @click="deleteAlarmRule()" round type="primary">Удалить</el-button>
      </el-main>
      <!--/Область контента-->
    </el-container>
  </el-container>
...
<script>
  ...
  export default {
    ...
    beforeCreate: function () {
      ...
      this.$store.dispatch('alarmRuleEditSetCid', currentComponent.cid);
      let params = this.$route.params;
      let method = 'getNewAlarmRule';
      if (funcUtils.isNotEmpty(params.id)) {
        method = 'getAlarmRule';
      } else if (funcUtils.isEmpty(params.id) && (funcUtils.isEmpty(params.executerId) && funcUtils.isEmpty(params.sourceType) && funcUtils.isEmpty(params.sourceId))) {
        method = 'restore';
        params = null;
      }
      let requestHead = new RequestEntity.RequestHead(localStorage.getItem('sid'), wid, currentComponent.cid, this.$store.state.alarmRuleEdit.bean, method);
    ...
    methods: {
      saveAlarmRule: function () {
        ...
        let componentsRoute = funcUtils.getFromSessionStorage(wid);
        let currentComponent = funcUtils.getCurrentComponent(componentsRoute);
        let requestHead = new RequestEntity.RequestHead(localStorage.getItem('sid'), wid, currentComponent.cid, this.$store.state.alarmRuleEdit.bean, 'saveAlarmRule');
      ...
      deleteAlarmRule: function () {
        ...
        let componentsRoute = funcUtils.getFromSessionStorage(wid);
        let currentComponent = funcUtils.getCurrentComponent(componentsRoute);
        let requestHead = new RequestEntity.RequestHead(localStorage.getItem('sid'), wid, currentComponent.cid, this.$store.state.alarmRuleEdit.bean, 'deleteAlarmRule');

    ...
    <div>
        ...
        <el-tabs v-model="activeTab" class="dc-alert-passport__action-tabs">
            ...
            <el-tab-pane label="действия в работе" name="working-actions">
                <span slot="label" class="dc-alert-passport__tab-title flex-parent flex-parent--center-cross">
                    <i class="dc-alert-passport__icon dc-alert-passport__icon--working-actions "></i>
                    действия в работе
                </span>

                <template v-for="action in workingActionsList">
                    <div :class="['dc-alert-passport__action-item', action.cssClass, {'is-active': action.active}, {'is-disabled': !action.enabled}]">
            ...
            <el-tab-pane label="шаблоны действий" name="actions-chooser">
                ...
                <div :class="['dc-alert-passport__carousel',  {'dc-alert-passport__carousel--expanded': activeActionsTemplate} ]">
                    <div class="dc-alert-passport__carousel__wrap">
                        ...
                        <div class="dc-alert-passport__carousel__slide">
                            <div class="dc-alert-passport__carousel__slide__header flex-parent flex-parent--space-between-main"
                                 ...
                                 @click="activeActionsTemplate = null">
                                <div>
                                    <div class="dc-alert-passport__carousel__slide__heading">
                                        {{actionsTemplateList[0].title}}
                                    </div>
                                    <div class="dc-alert-passport__carousel__slide__subheading">
                                        действий: <span>{{actionsTemplateList[0].templateActions.length}}</span>
                                    </div>
                                </div>
                            ...
                            <template v-for="templateActions in actionsTemplateList[0].templateActions">
                                <div :class="['dc-alert-passport__action-item', 'is-paused', {'is-active': templateActions.active}, {'is-disabled': !templateActions.enabled}]">
                                    <div class="dc-alert-passport__action-item__cols">
                                        <div class="dc-alert-passport__action-item__status"></div>
                                        <div class="dc-alert-passport__action-item__info">
                                            <div class='grid'>
        ...
        data() {
            return {
                ...
                workingActionsList: [
                    ...
                    {
                        date: 'Fri Aug 17 2018 23:13:41',
                        title: 'Чистка оправ',
                        cssClass: 'is-working',
                        status: 'выполняется',
                        enabled: true,
                        active: true,
                        person: 'Торвлобнор Петрович Пуздой'
                    },
                    {
                        date: 'Fri Aug 15 2018 06:57:47',
                        title: 'Чистка оправ',
                        cssClass: 'is-queue',
                        status: 'в очереди',
                        enabled: false,
                ...
                actionsTemplateList: [
                    ...
                    {
                        title: 'темплейт созидания',
                        active: true,
                        templateActions: []
                    },
                    {
                        title: 'темплейт откровения',
                        active: false,
                        templateActions: []
                    },
                    {
                        title: 'темплейт “гнев оракула”',
                        active: false,
                        templateActions: []
                    }
                ]
